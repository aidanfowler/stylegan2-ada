...
def setup_training_options(
    ...
    args.network_snapshot_ticks = 20
    ...
    cfg_specs = {
        ...
        'aidan':     dict(ref_gpus=4,  kimg=25000,  mb=16, mbstd=4,  fmaps=1,   lrate=0.002,  gamma=10,    ema=10,  ramp=None, map=8),
        'aidan-complex':    dict(ref_gpus=4,  kimg=25000,  mb=16, mbstd=4,  fmaps=1,   lrate=0.002,  gamma=2,    ema=10,  ramp=None, map=8),
        'aidantest1gpu':    dict(ref_gpus=1,  kimg=25000,  mb=4, mbstd=4,  fmaps=1,   lrate=0.002,  gamma=2,    ema=10,  ramp=None, map=8), #for running on 1 gpu before scheduling on 4
...
def main():
    ...
    group.add_argument('--cfg',   help='Base config (default: auto)', choices=['auto', 'aidan','aidan-complex', 'aidantest1gpu', 'stylegan2', 'paper256', 'paper512', 'paper1024', 'cifar', 'cifarbaseline'])
